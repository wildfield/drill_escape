...
class ApplicationMain {
	...
	public static function create ():Void {
		...
		urls.push ("assets/data/map2.txt");
		types.push (AssetType.TEXT);
		
		
		urls.push ("assets/data/map3.txt");
		types.push (AssetType.TEXT);
		
		
		urls.push ("assets/data/map4.txt");
		types.push (AssetType.TEXT);
		
		
		urls.push ("assets/data/map5.txt");
		types.push (AssetType.TEXT);
		...
		urls.push ("assets/sounds/drill.wav");
		types.push (AssetType.SOUND);
		
		
		urls.push ("assets/sounds/next_level.wav");
		types.push (AssetType.SOUND);
